<%-- 
    Document   : GuestNotifications
    Created on : 12 6, 23, 1:29:01 AM
    Author     : Patrick
--%>
...
<html>
    <head>
        ...
        <title>Guest Notifications Page</title>
    </head>
    <body class="guest-notifications">
        <div class="notifications-view">
            <div class="blue-rectangle">
                <div class="text-1">NOTIFICATIONS</div>
                <a href="GuestBrowsing.jsp"><img class="x-icon" src="images/x.png" /></a>
                <img class="guest-icon" src="images/guest.png" />
            </div>
            <div class="text-2">NO NOTIFICATIONS</div>
