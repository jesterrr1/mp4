<%-- 
    Document   : UserDropdown
    Created on : 12 6, 23, 1:34:59 AM
    Author     : Patrick
--%>
    ...
    <body class="user-dropdown">
        <div class="dropdown-profile-view">
            <a href="UserBrowsing.jsp"><img class="x-icon" src="images/x.png" /></a>
                ...
                <a href="UserAccount.jsp"><div class="text-2">Account</div></a>
                <div class="line-2"></div>
                <a href=""><div class="text-3">Purchases</div></a>
                <div class="line-3"></div>
                <a href="UserAboutUs.jsp"><div class="text-4">About Us</div></a>
        </div>
        <div class="container">
